...
public class SearchPageObject extends MainPageObject {
    ...
    {
        this.waitForElementAndClick(By.xpath(SEARCH_INIT_ELEMENT), "Cannot find and click " +
    ...
    {
        this.waitForElementAndSendKeys(By.xpath(SEARCH_INPUT), search_line, "Cannot find and type" +
                "into search input", 5);
    }
    ...
    {
        String search_result_xpath = getResultSearchElement(substring);
        this.waitForElementAndClick(By.xpath(search_result_xpath), "Cannot find and click " +
    ...
    {
        this.waitForElementPresent(By.xpath(SEARCH_EMPTY_RESULT_ELEMENT), "Cannot find " +
                "empty result element", 15);
    }

    public void assertThereIsNoResultOfSearch()
    {
        this.assertElementsNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "We supposed not " +
                "to find any results");
    }

    public void assertSearchInputIsPresentAndEmpty()
    {
        this.waitForElementPresent(By.xpath(SEARCH_INPUT), "Search input is not empty",
                10);
    }
